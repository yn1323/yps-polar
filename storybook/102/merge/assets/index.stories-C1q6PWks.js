import{w as S,e as c,u as r}from"./index-B7YJKKKT.js";import{j as e}from"./walk-object-CiAimSH9.js";import{c as P,r as A}from"./server-B4xS7qA5.js";import{u as D,d as C,e as h}from"./index-CD1kTnmM.js";import{B as x,L as w}from"./link-B7tE-ggm.js";import{h as R}from"./index-CI9keGzL.js";import{s as _}from"./schema-CPReomcP.js";import{S as g,B as q}from"./stack-DZl6kS95.js";import{C as G,F as f,b as B,I as v,d as y}from"./input-B8ZVAnYZ.js";import{L as E}from"./link-Cp4YXEYc.js";import"./jsx-runtime-Bw5QeaCk.js";import"./index-D3ueQH4H.js";import"./index-DCCrmINF.js";import"./iframe-B9yq-nAq.js";import"./field.anatomy-CcSQSJVj.js";import"./types-DwQkBYn-.js";import"./_interop_require_wildcard-BLzwqx1Q.js";import"./add-base-path-CCQl4eex.js";const M=async({email:a,password:t})=>{const n=await P(),s={email:a,password:t},{error:i}=await n.auth.signInWithPassword(s);return A("/","layout"),{success:!i}},z=()=>{var u,l;const{register:a,handleSubmit:t,formState:{errors:n,isSubmitting:s}}=D({resolver:C(_)}),i=o=>{o?(h.create({description:"ログインに成功しました",type:"success"}),R("/mypage")):h.create({description:"ログインに失敗しました",type:"error"})},d=async o=>{const{success:F}=await M(o);i(F)};return e.jsx(G,{w:"96",p:"8",children:e.jsxs(g,{gap:"8",w:"full",children:[e.jsxs(g,{gap:"6",as:"form",onSubmit:o=>{o.preventDefault(),t(d)(o)},children:[e.jsxs(f,{invalid:!!n.email,children:[e.jsx(B,{children:"メールアドレス"}),e.jsx(v,{...a("email"),placeholder:"メールアドレスを入力してください",disabled:s}),e.jsx(y,{children:(u=n.email)==null?void 0:u.message})]}),e.jsxs(f,{invalid:!!n.password,children:[e.jsx(B,{children:"パスワード"}),e.jsx(v,{...a("password"),type:"password",placeholder:"パスワードを入力してください",disabled:s}),e.jsx(y,{children:(l=n.password)==null?void 0:l.message})]}),e.jsx(q,{variant:"solid",colorPalette:"teal",type:"submit",loading:s,children:"メールアドレスでログイン"})]}),e.jsxs(g,{w:"full",gap:"2",textAlign:"right",color:"gray.500",fontSize:"sm",children:[e.jsx(x,{children:e.jsx(E,{asChild:!0,_hover:{textDecoration:"underline"},children:e.jsx(w,{href:"/signin/signup",children:"新規登録"})})}),e.jsx(x,{children:e.jsx(E,{asChild:!0,_hover:{textDecoration:"underline"},children:e.jsx(w,{href:"/signin/forget",children:"パスワードを忘れた方"})})})]})]})})},re={title:"features/signin/SigninForm",component:z,args:{}},m={play:async({canvasElement:a})=>{const t=S(a),n=t.getByText("新規登録");c(n.getAttribute("href")).toBe("/signin/signup");const s=t.getByText("パスワードを忘れた方");c(s.getAttribute("href")).toBe("/signin/forget")}},p={play:async({canvasElement:a})=>{const t=S(a),n=t.getByRole("button",{name:"メールアドレスでログイン"});await r.click(n);const s=await t.findAllByText("必須項目です");c(s.length).toBeGreaterThan(0);const i=t.getByPlaceholderText("メールアドレスを入力してください");await r.clear(i),await r.paste("invalid-email"),await r.click(n);const d=await t.findByText("メールアドレスの形式で入力してください");c(d).toBeInTheDocument(),await r.clear(i),await r.paste("test@example.com"),t.getByPlaceholderText("パスワードを入力してください").focus(),await r.paste("short"),await r.click(n);const l=await t.findByText("8〜24文字で入力してください");c(l).toBeInTheDocument()}};var b,j,T;m.parameters={...m.parameters,docs:{...(b=m.parameters)==null?void 0:b.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
